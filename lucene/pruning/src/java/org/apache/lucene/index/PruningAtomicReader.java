...
public class PruningAtomicReader extends FilterAtomicReader {
  ...
  public final static class PruningTermsEnum extends FilterTermsEnum {
    ...
    public boolean seekExact(BytesRef text) throws IOException {
      boolean toReturn = super.seekExact(text);
      if (toReturn) {
        this.termPolicy.initPositionsTerm(this.field, this);
      }
      return toReturn;
    }
    ...
    public SeekStatus seekCeil(BytesRef text) throws IOException {
      SeekStatus toReturn = super.seekCeil(text);
      if (toReturn == SeekStatus.FOUND) {
        this.termPolicy.initPositionsTerm(this.field, this);
      }
      return toReturn;
    }
