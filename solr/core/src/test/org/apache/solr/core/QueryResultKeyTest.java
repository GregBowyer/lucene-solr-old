...
public class QueryResultKeyTest extends SolrTestCaseJ4 {
  ...
  public void testFiltersHashCode() {
    ...
    CollectorSpec collectorSpec = null;
    
    QueryResultKey qrk1 = new QueryResultKey(query , filters, sort, collectorSpec, 1);
    ...
    QueryResultKey qrk2 = new QueryResultKey(query , filters2, sort, collectorSpec, 1);
